          ...
          >
            ...
            <div className="glass-effect rounded-2xl p-8 flex justify-between items-center text-left hover:-translate-y-1 transition-transform border border-blue-200 dark:border-blue-900/50">
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">View my latest resume in PDF format.</p>
              </div>
              <a href={resumePDF} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow-md shadow-blue-500/30 transition-all">
                View Resume
              </a>
            </div>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  placeholder="workingaditya@gmail.com"
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
                />
              </div>
